...
" }}}
" Colors: {{{
let s:bg = g:colors_bg
let s:fg = g:colors_fg
let s:red = g:colors_red
let s:green = g:colors_green
let s:yellow = g:colors_yellow
let s:blue = g:colors_blue
let s:cyan = g:colors_cyan
let s:purple = g:colors_purple
" }}}
" General: {{{
